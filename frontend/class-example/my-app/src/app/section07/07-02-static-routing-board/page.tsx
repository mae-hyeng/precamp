...
export default function StaticRoutingPage() {
    ...
    return (
        <div>
            <button onClick={onClickSubmit1}>1번 게시글 게시글 등록하기</button>
            <br />
            <button onClick={onClickSubmit2}>2번 게시글 게시글 등록하기</button>
            <br />
            <button onClick={onClickSubmit3}>3번 게시글 게시글 등록하기</button>
            <br />
        </div>
    );
}
